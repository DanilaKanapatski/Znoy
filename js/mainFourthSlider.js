document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateButtonStyles() {
        const prevBtn = document.querySelector('.fourthSlider-prev');
        const nextBtn = document.querySelector('.forthSlider-next');
