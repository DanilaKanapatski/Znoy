document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateButtonStyles() {
        const prevBtn = document.querySelector('.seventhSlider-prev');
        const nextBtn = document.querySelector('.seventhSlider-next');
